...
QJsonTranslator* QJsonTranslator::instance(void)
{
	...
	if (!translator)
		translator = new QJsonTranslator();
...
QJsonTranslator::QJsonTranslator(QObject *parent)
	: QTranslator(parent), pLoaded(false)
{
...
void QJsonTranslator::checkSynonymous(QString &check) const
{
